  ...
  return (
    <div
      className={clsx(
        ...
        'bg-aegis-card/95 backdrop-blur-md border border-aegis-border',
...
export function ExpandableCard({
  ...
  return (
    <div className={clsx('rounded-xl border border-aegis-border overflow-hidden', className)}>
      {/* header */}
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={clsx(
          ...
          'hover:bg-white/[0.02]',
          open && 'border-b border-aegis-border'
        )}
      >
...
export function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'bg-aegis-card border border-aegis-border rounded-2xl w-full max-w-sm p-6',
...
export function DiffPreviewModal({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'bg-aegis-card border border-aegis-border rounded-2xl w-full max-w-3xl',
